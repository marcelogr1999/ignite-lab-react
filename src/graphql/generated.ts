...
export type GetLessonsQuery = { __typename?: 'Query', lessons: Array<{ __typename?: 'Lesson', availableAt?: any | null, lessonType: LessonType, slug: string, title: string, id: string }> };
